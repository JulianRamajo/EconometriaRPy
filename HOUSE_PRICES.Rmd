---
title: "Análisis de datos espaciales: precio de la vivienda en Ohio (condado de Lucas)"
author: "J. Ramajo"
date: '2020'
output:
...
class(house)
summary(house@data)
# writeOGR(house, layer = "HOUSE_PRICES", driver="ESRI Shapefile", dsn = "~/Documentos/R/EcMetrics_Ramajo/HOUSPR_OHIO")
#
library(sf) 
library(leaflet) 
library(ggplot2)
