...
En esta aplicación se estimará una [función de consumo de tipo Keynesiano](https://es.wikipedia.org/wiki/Funci%C3%B3n_de_consumo) agregada (para un consumidor representativo), usando datos de series temporales para Estados Unidos durante el período 1959-2015 ( *t* = 1, 2,..., 57):
