...
summary(mod_1)
#
# Imputación simple: usar la media para predecir los datos faltantes de las variables explicativas
#
...
# para evitar que las predicciones se salgan del intervalo [0,1] y luego aplicar la transformación inversa a la predicción
#
...
# Esitmaciones, desviaciones estándar estimadas y estadísticos t (individuales y combinadas)
betas; se_betas
