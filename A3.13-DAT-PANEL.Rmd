---
title: 'TEMA 3: Modelos econométricos para datos de panel'
author:
  name: Julián Ramajo, ramajo@unex.es
  affiliation: GRADO EN ESTADÍSTICA | ECONOMETRIA (502243)
subtitle: 'Aplicación 3.13: Productividad de la industria química en China'
output:
  html_document:
    theme: journal
    highlight: haddock
...
En esta aplicación se estimará una función de producción del tipo Cobb-Douglas para una muestra de empresas del sector industrial químico de China. La versión econométrica de dicha función es la siguiente:
...
summary(modelo_ea)
# Comparación de los modelos de efectos aleatorios y de efectos fijos: test de Hausman
...
# Anexo: Paneles dinámicos en R -> Demanda de empleo en UK
