---
title: "Aplicación 2.1: El modelo CAPM (Capital Asset Pricing Model)"
output:
  html_document:
    df_print: paged
---
...
library(tidyverse)
library(readxl)
capm <- read_excel("~/Dropbox/Mi Mac (Mac Pro de Julián)/Documents/GitHub/EcoMetricsRPy/CAPM.xls")
head(capm)
summary(capm)
#
...
#
capm = pd.read_excel('~/Dropbox/Mi Mac (Mac Pro de Julián)/Documents/GitHub/EcoMetricsRPy/CAPM.xls', index_col=0)
capm.head()
capm.describe()
# 
def LogDiff(x):
