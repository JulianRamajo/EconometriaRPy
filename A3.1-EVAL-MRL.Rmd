---
title: 'TEMA 3: Evaluación, validación y especificación del MRL'
author:
...
En esta aplicación se estimará un modelo de regresión basado en la teoría de los precios de arbitraje (*Arbitrage Pricing Theory*, APT). Para más información sobre esta teoría se puede consultar la página: <https://es.wikipedia.org/wiki/Teor%C3%ADa_del_arbitraje>.
...
# Lectura de datos
apt = pd.read_excel('APT_MICROSOFT.xls', parse_dates=['Date'], index_col='Date')
# Estructura de la base de datos
apt.info()
apt.head()
apt.tail()
