...
En esta aplicación se estimará una [función de producción del tipo Cobb-Douglas](https://en.wikipedia.org/wiki/Cobb%E2%80%93Douglas_production_function) para una muestra de empresas del sector industrial químico de China. La versión econométrica de dicha función es la siguiente:
