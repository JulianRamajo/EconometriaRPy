...
::: justify
# Aplicación 2.1 (Estimación MCO y contrastes de hipótesis): Modelo CAPM para las acciones del Banco Santander {.unnumbered}
...
Como ejercicio, se pueden repetir todos los cálculos de la aplicación para analizar las empresas Telefónica e Inditex.
:::
...
import scipy as sp
# Lectura de datos
CAPM_ESP = pd.read_csv('data/CAPM_ESP.csv', delimiter=';', parse_dates=['date'], index_col='date')
CAPM_ESP.head()
CAPM_ESP.tail()
# Transformación de variables
def LogDiff(x):
