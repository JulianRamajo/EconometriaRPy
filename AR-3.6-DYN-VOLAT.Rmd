...
En esta aplicación se estimará un modelo dinámico para el precio de la gasolina en el que los errores presentan volatilidad variable en el tiempo.
...
summary(dyn_model)
#
# Efectos parciales a corto y largo plazo
#
