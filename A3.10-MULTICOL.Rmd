...
En este ejercicio se intentará explicar la rentabilidad anual (RENTAB) obtenida por 80 empresas inglesas, utilizando para ello diferente información contable interna en forma de ratios económico-financieros (R1, R2,…, R10), así como datos sobre el volumen de ventas totales (VT) y el tamaño de las empresas, medido este último por el valor total de los activos (AT).
