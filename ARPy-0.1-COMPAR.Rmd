...
subtitle: 'Aplicación 0.1: Lenguajes de programación'
output:
  html_document:
    theme: journal
    highlight: haddock
...
# Notar que el uso de $ devuelve un vector, mientras que la especificación de ["nombre"]
# devuelve un data.frame con una columna (como es evidente por el formato de salida).
#
...
# necesite ser definido cuando un objeto de esta clase es creado por primera vez. 
