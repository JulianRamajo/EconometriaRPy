...
::: justify
# Aplicación 1.1 (Datos de corte transversal): Demanda familiar de carne {.unnumbered}

En esta aplicación se estimará una [curva de demanda](https://es.wikipedia.org/wiki/Curva_de_demanda) de carne con datos microeconómicos sobre 30 familias americanas ( *i* = 1, 2,..., 30):
