...
subtitle: 'Aplicación 3.3: No normalidad y observaciones atípicas'
output:
  html_document:
    theme: journal
    highlight: haddock
...
En esta aplicación se tratará el tema de la no normalidad de los erroes causada por la presencia de observaciones atípicas, y se propondrán estimadores que son 'robustos' ante la presencia de dichos datos.
