...
::: justify
# Aplicación 3.12: Variable dependiente discreta o limitada {.unnumbered}

## Variable dependiente discreta (modelos Logit y Probit)  {.unnumbered}

### Préstamos hipotecarios {.unnumbered}
...
::: justify
## Variable dependiente limitada (valores censurados: modelo Tobit):  {.unnumbered}

### Compra de automóviles {.unnumbered}
...
::: justify
## Variable dependiente limitada (truncamiento selectivo: modelo Heckit de selección muestral):  {.unnumbered}

### Salarios de las mujeres casadas {.unnumbered}
