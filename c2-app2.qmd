...
::: justify
# Aplicación 2.2 (Predicción con el modelo de regresión lineal): Curva de Engel para el gasto en alimentos {.unnumbered}

En esta aplicación se estimará una curva de Engel que relaciona el gasto familiar en alimentación ($GALIM$) con la renta disponible ($RENTA$), 
...
library(skimr)
# Lectura de datos
ENGEL_ALIM <- read_delim("data/ENGEL_ALIM_USA.csv", ";", escape_double = FALSE, trim_ws = TRUE)
