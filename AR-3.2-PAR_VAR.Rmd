...
subtitle: 'Aplicación 3.2: Exportaciones españolas. Salarios diferenciados por sexos'
output:
  html_document:
    theme: journal
    highlight: haddock
...
En esta aplicación se estimarán dos regresiones que permiten parámetros no constantes. En la primera de ellas se trabajará con datos de series temporales, mientras que en la segunda se usarán datos de corte transversal.

# Exportaciones españolas 1970-1997
...
# Diferenciación salarial por sexo
