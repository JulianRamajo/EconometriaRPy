---
title: 'TEMA 3: Regresiones con dependencia espacial en los datos'
author:
  name: Julián Ramajo, ramajo@unex.es
  affiliation: GRADO EN ESTADÍSTICA | ECONOMETRIA (502243)
subtitle: 'Aplicación 3.7: Precios de la vivienda el condado de Lucas (estado de Ohio, Estados Unidos)'
output:
  html_document:
    theme: journal
    highlight: haddock
...
En esta aplicación se propondrán modelos de regresión en los que las variables y/o los errores presentan autocorrelación espacial.
