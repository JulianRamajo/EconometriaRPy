...
## Caso univariante (especificación ARDL): Tipos de interés en España {.unnumbered}
...
::: justify
## Caso multivariante (especificación VAR): Evolución temporal de tipos de cambio {.unnumbered}

En esta aplicación se estimará un modelo vectorial autorregresivo para explicar la evolución en el tiempo de los tipos de cambio respecto al dólar de tres de las principales monedas al nivel mundial, el euro, la libra y el yen.
:::
