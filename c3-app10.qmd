...
::: justify
# Aplicación 3.10 (Información muestral - Multicolinealidad): Análisis de la rentabilidad empresarial {.unnumbered}
...
library(mctest)
# Lectura de datos
RENTAB_EMP <- read_delim("data/RENTAB_EMP.csv", ";", escape_double = FALSE, trim_ws = TRUE)
summary(RENTAB_EMP)
