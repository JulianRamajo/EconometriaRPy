...
En esta aplicación se usarán las librerías estándar de R y Python para el "manejo de datos" (*data wrangling*), replicando los resultados con los correspondientes comandos en ambos lenguajes.
...
diferenciado por sexo con línea de regresión añadida
