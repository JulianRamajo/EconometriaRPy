...
::: justify
# Aplicación 1.1.b (Gestión y representación gráfica de datos): Gestión de datos con R y Python {.unnumbered}
...
paquete *Tidyverse* (<https://www.tidyverse.org/packages/>), y para
Python se usarán las librerías *NumPy* (<https://numpy.org/>), *pandas*
(<https://pandas.pydata.org/>), *Matplotlib* (<https://matplotlib.org/>)
y *seaborn* (<https://seaborn.pydata.org/>). Las librerías
especializadas en estadística y econometría se verán en aplicaciones
posteriores.

Sobre los datos utilizados:

-   Datos para el ejemplo : `palmerpenguins`
...
Para eliminar todas las filas con un NA habría que ejecutar el siguiente
código
...
Cálculo de los cuantiles 25, 50 y 75 para la longitud y profundidad del
pico en la Isla Biscoe
...
Diagrama de dispersión de la masa corporal en relación con la longitud
de las aletas
...
Media y desviación estándar de la longitud del pico de cada especie por
sexo
...
Añadir una nueva columna al fichero de datos que muestre la longitud
media de las aletas agrupadas por especies
...
Puntuación estandarizada (z-score) por especie para la longitud de las
aletas
...
Añadir una columna para la media y la desviación estándar por especie
para la longitud del pico
...
Crear una nueva columna que codifique las islas como: Biscoe = Isla1
Sueño = Isla2 Torgersen = Isla3
