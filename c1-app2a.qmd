...
# desde el año 2000 hasta la fecha realización de esta aplicación:
...
pSAN = yf.download("SAN.MC", start="2000-01-01", end="2023-05-23")
print(pSAN)
...
pSAN['ret']
# Cálculo alternativo de los rendimientos diarios
ret2 = (pSAN
  .sort_values("Date")
