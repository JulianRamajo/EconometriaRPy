...
plt.show()
(ggplot(data_daily,aes('l_pSP500','l_pMSFT')) + geom_point() + geom_smooth(method='lm',se=False, color = "blue") + labs(x="Índice S&P 500 (log)",y="Precio diario acciones de Microsoft (log)") + theme_bw())
# Regresión lineal simple
