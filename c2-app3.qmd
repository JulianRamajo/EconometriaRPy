...
::: justify
# Aplicación 2.3: Modelo de regresión lineal con forma funcional polinómica {.unnumbered}

## Curva de costes en el sector textil {.unnumbered}

En esta aplicación trabajaremos con datos de series temporales que consisten en 28 observaciones mensuales sobre los costes totales (_COST_) y la cantidad producida (_Q_) de una empresa del sector textil.
