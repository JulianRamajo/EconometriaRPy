---
title: 'Aplicación 2.3: Efectos diferenciados de la publicidad sobre las ventas'
output:
  html_document:
    df_print: paged
---
...
library(readr)
#
PUB_VENTAS <- read_csv("~/Dropbox/Mi Mac (Mac Pro de Julián)/Documents/GitHub/EcoMetricsRPy/PUB_VENTAS.csv")
#
library(plotly)
library(magrittr)
#  
...
#
PUB_VENTAS = pd.read_csv('~/Dropbox/Mi Mac (Mac Pro de Julián)/Documents/GitHub/EcoMetricsRPy/PUB_VENTAS.csv')
#
