...
subtitle: 'Aplicación 3.7: Modelos ARDL y VAR'
output:
  html_document:
    theme: journal
    highlight: haddock
...
# Autocorrelación y regresiones dinámicas (caso univariante): Tipos de interés en España en la década de 1980

## Objetivo

En esta aplicación se estimará un modelo de regresión con autocorrelación en los errores y se propondrán soluciones al problema.
...
# Regresiones dinámicas (caso multivariante): Evolución temporal de los tipos de cambio
