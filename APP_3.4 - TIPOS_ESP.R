...
#
# Modelo ARDL(0,0,0) -estático- 
S(dynlm_KM_0 <- dynlm(RL ~ R3M + RD))
# Contrastes de correlación serial (autocorrelación)
#
# Correlograma
...
#
# Corrección de la autocrrelación: MCO corregidos, MCG-AR, modelos ARDL
#
# Errores estándar robustos, HAC (Newey-West)
S(dynlm_KM_0 <- dynlm(RL ~ R3M + RD), vcov.=vcovHAC(dynlm_KM_0))
# Minímos cuadrados generalizados (MCG): errores AR(1)
